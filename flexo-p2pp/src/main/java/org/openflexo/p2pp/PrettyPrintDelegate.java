...
/**
 * A delegate providing pretty-print to any Object.<br>
 * 
 * @author sylvain
 * 
 */
public interface PrettyPrintDelegate<T> {

	/**
	 * Returned object being pretty-printed by this delegate
	 * 
	 * @return
	 */
	...
	/**
	 * Return representation for that object<br>
	 * 
	 * This representation might be different as the normalized one, as the underlying Object could be obtained from a parsed file. Some
