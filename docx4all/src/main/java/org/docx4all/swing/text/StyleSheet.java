...
public class StyleSheet extends StyleContext {
	...
	private final static int SCREEN_RESOLUTION_DPI = Toolkit.getDefaultToolkit().getScreenResolution();
	...
	public static final StyleSheet getDefaultStyleSheet() {
		...
		if (defaultStyleSheet == null) {
			...
			ObjectFactory defaultFactory = new ObjectFactory();
			defaultStyleSheet.setWordprocessingMLPackage(defaultFactory.createEmptyDocumentPackage());
	...
	public final static void addAttributes(MutableAttributeSet attrs, TblPr tblPr) {
		...
		if (tblBorders != null) {
			org.docx4all.xml.type.TblBorders value = new org.docx4all.xml.type.TblBorders(tblBorders);
			...
			tblBorders = org.docx4all.xml.type.ObjectFactory.createTblBorders(left, top, right, bottom, insideH, insideV);
			org.docx4all.xml.type.TblBorders value = new org.docx4all.xml.type.TblBorders(tblBorders);
			attrs.addAttribute(WordMLStyleConstants.TblBordersAttribute, value);
			tblBorders = null;
		}
		...
		tw = tblPr.getTblW();
		if (tw != null) {
			org.docx4all.xml.type.TblWidth tblWidth = new org.docx4all.xml.type.TblWidth(tw);
		...
		if (tmar != null) {
			...
			tw = tmar.getRight();
			if (tw != null) {
				org.docx4all.xml.type.TblWidth right = new org.docx4all.xml.type.TblWidth(tw);
			...
			tw = tmar.getTop();
			if (tw != null) {
				org.docx4all.xml.type.TblWidth top = new org.docx4all.xml.type.TblWidth(tw);
				if (top.getType() == org.docx4all.xml.type.TblWidth.Type.DXA || top.getType() == org.docx4all.xml.type.TblWidth.Type.NIL) {
			...
			tw = tmar.getBottom();
			if (tw != null) {
				org.docx4all.xml.type.TblWidth bottom = new org.docx4all.xml.type.TblWidth(tw);
		...
		if (tw != null) {
			org.docx4all.xml.type.TblWidth space = new org.docx4all.xml.type.TblWidth(tw);
			if (space.getType() == org.docx4all.xml.type.TblWidth.Type.DXA || space.getType() == org.docx4all.xml.type.TblWidth.Type.NIL) {
				int ignoreThisParam = 0;
	...
	public final static void addAttributes(MutableAttributeSet attrs, TrPr trPr) {
		...
		for (JAXBElement<?> elem : list) {
			...
			if (value instanceof CTHeight) {
				org.docx4all.xml.type.CTHeight trHeight = new org.docx4all.xml.type.CTHeight((CTHeight) value);
	...
	public final static void addAttributes(MutableAttributeSet attrs, TcPr tcPr) {
		...
		if (tcBorders != null) {
			org.docx4all.xml.type.TcBorders value = new org.docx4all.xml.type.TcBorders(tcBorders);
		...
		if (tw != null) {
			org.docx4all.xml.type.TblWidth tcWidth = new org.docx4all.xml.type.TblWidth(tw);
		...
		if (tcMar != null) {
			if (tcMar.getLeft() != null) {
				org.docx4all.xml.type.TblWidth w = new org.docx4all.xml.type.TblWidth(tcMar.getLeft());
				if (w.getType() == org.docx4all.xml.type.TblWidth.Type.DXA || w.getType() == org.docx4all.xml.type.TblWidth.Type.NIL) {
			...
			if (tcMar.getRight() != null) {
				org.docx4all.xml.type.TblWidth w = new org.docx4all.xml.type.TblWidth(tcMar.getRight());
				if (w.getType() == org.docx4all.xml.type.TblWidth.Type.DXA || w.getType() == org.docx4all.xml.type.TblWidth.Type.NIL) {
			...
			if (tcMar.getTop() != null) {
				org.docx4all.xml.type.TblWidth w = new org.docx4all.xml.type.TblWidth(tcMar.getTop());
				if (w.getType() == org.docx4all.xml.type.TblWidth.Type.DXA || w.getType() == org.docx4all.xml.type.TblWidth.Type.NIL) {
			...
			if (tcMar.getBottom() != null) {
				org.docx4all.xml.type.TblWidth w = new org.docx4all.xml.type.TblWidth(tcMar.getBottom());
				if (w.getType() == org.docx4all.xml.type.TblWidth.Type.DXA || w.getType() == org.docx4all.xml.type.TblWidth.Type.NIL) {
	...
	public final static void addTabsAttributes(MutableAttributeSet attrs, PPr pPr) {
		...
		if (tabs != null) {
			...
			if (!list.isEmpty()) {
				javax.swing.text.TabStop[] tabStops = new javax.swing.text.TabStop[list.size()];
				for (Integer i = 0; i < list.size(); i++) {
					...
					tabStops[i] = new javax.swing.text.TabStop(toPixels(pos.intValue()), toSwingTabStopAlignment(val),
	...
	protected void initDefaultStyle(org.docx4j.wml.Styles docxStyles) {
		...
		StyleConstants.setFontFamily(defaultStyle, FontManager.getInstance().getDocx4AllDefaultFontFamilyName());
		StyleConstants.setFontSize(defaultStyle, FontManager.getInstance().getDocx4AllDefaultFontSize());

		if (docxStyles.getDocDefaults() != null && docxStyles.getDocDefaults().getPPrDefault() != null) {
		...
		if (docxStyles.getDocDefaults() != null && docxStyles.getDocDefaults().getRPrDefault() != null) {
	...
	protected void initLatentStyles(org.docx4j.wml.Styles docxStyles) {
		...
		if (list != null) {
			...
			for (LsdException lsd : list) {
				...
				temp.addAttribute(WordMLStyleConstants.DocxObjectAttribute, lsd);

				if (lsd.getUiPriority() != null) {
					temp.addAttribute(WordMLStyleConstants.UiPriorityAttribute, new Integer(lsd.getUiPriority().intValue()));
				}
				temp.addAttribute(WordMLStyleConstants.QFormatAttribute, Boolean.valueOf(lsd.isQFormat()));
	...
	protected void initStyles(org.docx4j.wml.Styles docxStyles) {
		...
		for (org.docx4j.wml.Style st : styleList) {
			...
			tmpStyle.addAttribute(WordMLStyleConstants.StyleUINameAttribute, uiName);
			tmpStyle.addAttribute(WordMLStyleConstants.DocxObjectAttribute, st);
			tmpStyle.addAttribute(WordMLStyleConstants.StyleIdAttribute, st.getStyleId());
			...
			if (st.getQFormat() != null) {
				tmpStyle.addAttribute(WordMLStyleConstants.QFormatAttribute, Boolean.valueOf(st.getQFormat().isVal()));
			}

			tmpStr = (st.getType() == null) ? PARAGRAPH_ATTR_VALUE : st.getType();
			tmpStyle.addAttribute(WordMLStyleConstants.StyleTypeAttribute, tmpStr);
			...
			if (st.getLink() != null) {
				...
				if (target != null) {
					org.docx4j.wml.Style targetDocxStyles = (org.docx4j.wml.Style) target
							.getAttribute(WordMLStyleConstants.DocxObjectAttribute);
					String targetType = (String) target.getAttribute(WordMLStyleConstants.StyleTypeAttribute);
					if (PARAGRAPH_ATTR_VALUE.equalsIgnoreCase(tmpStr) && CHARACTER_ATTR_VALUE.equalsIgnoreCase(targetType)
							&& targetDocxStyles.getRPr() != null) {
						StyleSheet.addAttributes(tmpStyle, targetDocxStyles.getRPr());

					} else if (CHARACTER_ATTR_VALUE.equalsIgnoreCase(tmpStr) && PARAGRAPH_ATTR_VALUE.equalsIgnoreCase(targetType)
			...
			if (st.isDefault() && qformat.booleanValue() && uiName.startsWith("Normal") && PARAGRAPH_ATTR_VALUE.equalsIgnoreCase(tmpStr)) {
		...
		for (Style style : stylesWithBasedOn) {
			...
			if (parent != null) {
				...
				if (type.equals(parentType)) {
					if (PARAGRAPH_ATTR_VALUE.equals(type) || CHARACTER_ATTR_VALUE.equals(type)) {
