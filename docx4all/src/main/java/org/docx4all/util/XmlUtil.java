...
public class XmlUtil {
	...
	private final static SimpleDateFormat RFC3339_FORMAT = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'");
	...
	/**
	 * Deserialise the inputstream from pkg:package format into a WordprocessingMLPackage.
	 * 
	 * @param wmlPackage
	 * @param in
	 */
	public final static WordprocessingMLPackage deserialize(WordprocessingMLPackage wmlPackage, InputStream in, IObjectFactory objectFactory) {
		...
		try {
			...
			javax.xml.bind.JAXBElement je = (javax.xml.bind.JAXBElement) u.unmarshal(new javax.xml.transform.stream.StreamSource(in));
			...
			if (wmlPackage == null) {
				wmlPackage = objectFactory.createDocumentPackage((org.docx4j.wml.Document) ((JaxbXmlPart) tmpDocPart).getJaxbElement());
			} else {
				wmlPackage.getMainDocumentPart().setJaxbElement((org.docx4j.wml.Document) ((JaxbXmlPart) tmpDocPart).getJaxbElement());
			}

			// That handled the Main Document Part; now set the Style part.
			wmlPackage.getMainDocumentPart().getStyleDefinitionsPart()
					.setJaxbElement((org.docx4j.wml.Styles) ((JaxbXmlPart) tmpStylesPart).getJaxbElement());
	...
	/**
	 * 
	 * Filters out certain features of WordprocessingML which docx4all cannot yet handle, into something it can. Examples include proofErr,
	 * hyperlink, and lastRenderedPageBreak.
	 * 
	 * @param wmlPackage
	 */
	...
	public final static org.docx4j.docProps.custom.Properties.Property getCustomProperty(WordprocessingMLPackage wmlPackage,
			String propertyName) {
		...
		List<org.docx4j.docProps.custom.Properties.Property> list = (customProps != null) ? customProps.getProperty() : null;
	...
	public final static boolean isSharedDocumentPackage(WordprocessingMLPackage wmlPackage) {
		org.docx4j.docProps.custom.Properties.Property groupingProp = getCustomProperty(wmlPackage,
				Constants.PLUTEXT_GROUPING_PROPERTY_NAME);
		org.docx4j.docProps.custom.Properties.Property checkinProp = getCustomProperty(wmlPackage,
				Constants.PLUTEXT_CHECKIN_MESSAGE_ENABLED_PROPERTY_NAME);
		return (groupingProp != null && checkinProp != null);
	}

	public final static WordprocessingMLPackage createNewPackage(WordprocessingMLPackage source, boolean copyMainDocumentPart,
			boolean copyStyleDefPart, boolean copyDocPropsCustomPart, IObjectFactory objectFactory) throws InvalidFormatException {

		// Create a package
		WordprocessingMLPackage thePack = new WordprocessingMLPackage();

		// Check for source's document part
		org.docx4j.openpackaging.parts.WordprocessingML.MainDocumentPart srcDocumentPart = source.getMainDocumentPart();
		...
		if (srcDocumentPart == null) {
			...
			org.docx4j.openpackaging.parts.WordprocessingML.MainDocumentPart documentPart = new org.docx4j.openpackaging.parts.WordprocessingML.MainDocumentPart();
			Object jaxbElement;
			...
			if (srcStylesPart == null) {
				...
				org.docx4j.openpackaging.parts.WordprocessingML.StyleDefinitionsPart stylesPart = new org.docx4j.openpackaging.parts.WordprocessingML.StyleDefinitionsPart();
				if (copyStyleDefPart) {
	...
	public final static void setPlutextGroupingProperty(WordprocessingMLPackage wmlPackage, String value) {

		org.docx4j.openpackaging.parts.DocPropsCustomPart docPropsCustomPart = wmlPackage.getDocPropsCustomPart();
		org.docx4j.docProps.custom.Properties customProps = docPropsCustomPart.getJaxbElement();
		...
		org.docx4j.docProps.custom.Properties.Property groupingProp = XmlUtil.getCustomProperty(wmlPackage,
				Constants.PLUTEXT_GROUPING_PROPERTY_NAME);
		if (groupingProp == null) {
			...
			groupingProp.setFmtid(org.docx4j.openpackaging.parts.DocPropsCustomPart.fmtidValLpwstr); // Magic string
	...
	public final static void setPlutextCheckinMessageEnabledProperty(WordprocessingMLPackage wmlPackage, boolean enabled) {

		org.docx4j.openpackaging.parts.DocPropsCustomPart docPropsCustomPart = wmlPackage.getDocPropsCustomPart();
		org.docx4j.docProps.custom.Properties customProps = docPropsCustomPart.getJaxbElement();
		org.docx4j.docProps.custom.ObjectFactory factory = new org.docx4j.docProps.custom.ObjectFactory();

		org.docx4j.docProps.custom.Properties.Property checkinProp = XmlUtil.getCustomProperty(wmlPackage,
				Constants.PLUTEXT_CHECKIN_MESSAGE_ENABLED_PROPERTY_NAME);
		if (checkinProp == null) {
			checkinProp = factory.createPropertiesProperty();
			checkinProp.setName(Constants.PLUTEXT_CHECKIN_MESSAGE_ENABLED_PROPERTY_NAME);
			checkinProp.setFmtid(org.docx4j.openpackaging.parts.DocPropsCustomPart.fmtidValLpwstr); // Magic string
	...
	public final static void removePlutextProperty(WordprocessingMLPackage wmlPackage, String propertyName) {
		List<String> names = new ArrayList<String>(1);
		names.add(propertyName);
		removePlutextProperties(wmlPackage, names);
	}

	public final static void removePlutextProperties(WordprocessingMLPackage wmlPackage, List<String> propertyNames) {
	 ...
	 * 
	 * @param parent
	 *            the element whose children are to be deleted.
	...
	public final static void setAttributes(ElementML elem, AttributeSet paragraphAttrs, AttributeSet runAttrs, boolean replace) {
	...
	public final static void applyRemoteRevisions(javax.xml.transform.Source src, javax.xml.transform.Result result) {

		try {
			if (xsltApplyRemoteChanges == null) {
				Source xsltSource = new StreamSource(
						org.docx4j.utils.ResourceUtils.getResource("org/docx4all/util/ApplyRemoteChanges.xslt"));
				xsltApplyRemoteChanges = XmlUtils.getTransformerTemplate(xsltSource);
			}
			org.docx4j.XmlUtils.transform(src, xsltApplyRemoteChanges, null, result);
		} catch (Exception exc) {
			exc.printStackTrace();
		}
	}
	...
	public final static void discardRemoteRevisions(javax.xml.transform.Source src, javax.xml.transform.Result result) {

		try {
			if (xsltDiscardRemoteChanges == null) {
				Source xsltSource = new StreamSource(
						org.docx4j.utils.ResourceUtils.getResource("org/docx4all/util/DiscardRemoteChanges.xslt"));
				xsltDiscardRemoteChanges = XmlUtils.getTransformerTemplate(xsltSource);
			}
			org.docx4j.XmlUtils.transform(src, xsltDiscardRemoteChanges, null, result);
		} catch (Exception exc) {
			exc.printStackTrace();
		}
	}
	...
	public final static WordprocessingMLPackage export(WordprocessingMLPackage source, IObjectFactory objectFactory) {
		...
		try {
			...
			theResult = createNewPackage(source, copyMainDocumentPart, copyStyleDefPart, copyDocPropsCustomPart, objectFactory);
			if (xsltExport == null) {
				Source xsltSource = new StreamSource(org.docx4j.utils.ResourceUtils.getResource("org/docx4all/util/Export.xslt"));
	...
	/* Split a control containing n paragraphs
	  ...
	  */
	public final static List<SdtBlock> chunk(SdtBlock cc, IObjectFactory objectFactory) {
		SdtBlock copy = XmlUtils.deepCopy(cc);
		...
		if (children.size() > 1) {
			...
			for (int i = 1; i < children.size(); i++) {
				...
				if (o instanceof org.docx4j.wml.P || (o instanceof org.docx4j.wml.Tbl)) {
			...
			for (Object o : childrenToChunk) {
				children.remove(o);
				SdtBlock newChunk = createSdtBlock(objectFactory);
	...
	private final static SdtBlock createSdtBlock(IObjectFactory objectFactory) {
	...
	public final static boolean containsTrackedChanges(Object jaxbObject) {
		...
		return (s.indexOf("</w:ins>") >= 0 || s.indexOf("</w:del>") >= 0);
	}

	public final static org.docx4j.wml.SdtBlock markupDifference(org.docx4j.wml.SdtBlock leftSdt, org.docx4j.wml.SdtBlock rightSdt,
			Changeset changeset, IObjectFactory objectFactory) throws Exception {

		org.docx4j.wml.SdtBlock theSdt = objectFactory.createSdtBlock();
		theSdt.setSdtPr(XmlUtils.deepCopy(leftSdt.getSdtPr()));
		...
		pd.diff((org.docx4j.wml.SdtContentBlock) leftSdt.getSdtContent(), (org.docx4j.wml.SdtContentBlock) rightSdt.getSdtContent(),
				result, changeset.getModifier(), changeDate, new RelationshipsPart(), new RelationshipsPart());
	...
	public final static org.docx4j.wml.SdtBlock markupAsDeletion(org.docx4j.wml.SdtBlock sdt, Changeset changeset) throws Exception {
	...
	public final static org.docx4j.wml.SdtBlock markupAsDeletion(org.docx4j.wml.SdtBlock sdt, Map<String, Object> xsltParameters)
			throws Exception {
	...
	public final static org.docx4j.wml.SdtBlock markupAsDeletion(String sdtXmlString, Map<String, Object> xsltParameters) throws Exception {
		...
		if (xsltMarkupAsDeletion == null) {
			Source xsltSource = new StreamSource(org.docx4j.utils.ResourceUtils.getResource("org/docx4all/util/MarkupAsDeletion.xslt"));
			xsltMarkupAsDeletion = XmlUtils.getTransformerTemplate(xsltSource);
		}
		org.docx4j.XmlUtils.transform(src, xsltMarkupAsDeletion, xsltParameters, result);
	...
	public final static org.docx4j.wml.SdtBlock markupAsInsertion(org.docx4j.wml.SdtBlock sdt, Changeset changeset) throws Exception {
	...
	public final static org.docx4j.wml.SdtBlock markupAsInsertion(org.docx4j.wml.SdtBlock sdt, Map<String, Object> xsltParameters)
			throws Exception {
	...
	public final static org.docx4j.wml.SdtBlock markupAsInsertion(String sdtXmlString, Map<String, Object> xsltParameters) throws Exception {
		...
		if (xsltMarkupAsInsertion == null) {
			Source xsltSource = new StreamSource(org.docx4j.utils.ResourceUtils.getResource("org/docx4all/util/MarkupAsInsertion.xslt"));
			xsltMarkupAsInsertion = XmlUtils.getTransformerTemplate(xsltSource);
		}
		org.docx4j.XmlUtils.transform(src, xsltMarkupAsInsertion, xsltParameters, result);
