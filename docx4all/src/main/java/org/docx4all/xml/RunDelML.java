...
public class RunDelML extends ElementML {
	...
	public RunDelML(Object docxObject, ElementMLFactory elementMLFactory) {
		this(docxObject, elementMLFactory, false);
	}

	public RunDelML(Object docxObject, ElementMLFactory elementMLFactory, boolean isDummy) {
	...
	public Object clone() {
		...
		return new RunDelML(obj, getElementMLFactory(), this.isDummy);
	}
