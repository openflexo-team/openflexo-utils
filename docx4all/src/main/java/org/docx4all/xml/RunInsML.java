...
public class RunInsML extends ElementML {
	...
	public RunInsML(Object docxObject, ElementMLFactory elementMLFactory) {
		this(docxObject, elementMLFactory, false);
	}

	public RunInsML(Object docxObject, ElementMLFactory elementMLFactory, boolean isDummy) {
	...
	public Object clone() {
		...
		return new RunInsML(obj, getElementMLFactory(), this.isDummy);
	}
